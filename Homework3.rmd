...
``` {r}I searched for: (\w+), (\w+), (.*) which read; "look for one or more word characters, separated by commas and a single space and then look for the rest. I then replaced with: \2 \1 \(\3\) which read; "reverse the positions of the 1st and 2nd words you found and then put the rest in paranthesis"
```. 
